#ifndef JSON_PARSER_COMMON_HPP
#define JSON_PARSER_COMMON_HPP
...
namespace parser
{
    ...
    struct number_
        : seq_<opt_<char_<'-'> >, positive_, opt_<seq_<dot, positive_> >,
               opt_<seq_<e_, positive_> > >
    {
    };
